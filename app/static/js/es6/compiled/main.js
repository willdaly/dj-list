(function() {
  ...
  app.config(function($httpProvider) {
    ...
    $traceurRuntime.setProperty($httpProvider.defaults.headers.post, 'Content-Type', '' + 'application/x-www-form-urlencoded; charset=UTF-8');
  });
  $(document).ready(init);
  ...
  function createSong(e) {
    ...
    if (title !== '' && artist !== '') {
      ...
      $('.modal-header p').delay(2500).fadeOut(500, (function() {
